...
public class DemoAppMainFrame extends JFrame implements ActionListener, WindowListener
{
    ...
    private void init()
    {
        ...
        jMenuItem3.setAccelerator( javax.swing.KeyStroke.getKeyStroke( KeyEvent.VK_F4, java.awt.event.InputEvent.ALT_MASK ) );
        ...
        jTabbedPane2.setPreferredSize(new Dimension(800, 400));
        ...
        getContentPane().add( jTabbedPane2, BorderLayout.CENTER );
